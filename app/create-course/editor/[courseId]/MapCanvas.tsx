...
export function MapCanvas({
    ...
    const onSelectWeakFeatureRef = useRef(onSelectWeakFeature);
    ...
    useEffect(() => { onSelectWeakFeatureRef.current = onSelectWeakFeature; }, [onSelectWeakFeature]);
        ...
        map.on("load", async () => {
            ...
            for (const layer of ["weak-hole-feature-area-layer", "weak-hole-feature-area-outline-layer", "weak-hole-feature-line-layer", "weak-hole-feature-line-hit-layer"]) {
                map.on("click", layer, (event) => {
                    ...
                    onSelectWeakFeatureRef.current(id);
                });
            }
